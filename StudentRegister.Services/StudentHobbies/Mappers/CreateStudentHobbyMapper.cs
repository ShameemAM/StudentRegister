...
{
    public class CreateStudentHobbieMapper : Profile
    {
        public CreateStudentHobbieMapper()
        {
            CreateMap<CreateStudentHobbie, StudentHobbies>();
            CreateMap<StudentHobbies,CreateStudentHobbie>();
        }
    }
}
